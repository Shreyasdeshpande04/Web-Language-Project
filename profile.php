...
<html>
<head>
<title>EXPLORE INDIA | MY PROFILE</title>
...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">EXPLORE INDIA</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
...
<button type="submit" name="submit6" class="btn-primary btn">UPDATE THE INFOFORMATION</button>
<br>
